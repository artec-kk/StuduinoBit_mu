# -*- coding: utf-8 -*-
"""
This module contains functions for running remote commands on the Artec Studuino:bit
...
_HELP_TEXT = """
Interact with the basic filesystem on a connected Artec Studuino:bit device.
...
For example, 'ufs ls' will list the files on a connected Artec Studuino:bit.
"""
...
def clean_error(err):
    ...
    """
    return microfs.clean_error(err)
    '''
    if err:
...
def ls(serial=None):
    """
    List the files on the Studuino:bit.
